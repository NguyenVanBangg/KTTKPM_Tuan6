...
import com.example.helpper.XMLConvert;
    ...
    public String getMessToMq() throws NamingException {
        try {
            ...
            Destination destination
                    =(Destination) ctx.lookup("dynamicQueues/vanbang");
            //tạo connection
            ...
            System.out.println("Ti was listened on queue...");
                ...
                public void onMessage(Message msg) {
                    try {
                        if(msg instanceof TextMessage){
                            ...
                            tinnhan="Nhận tin : "+txt;
                            System.out.println("Tin Nhắn :"+tinnhan);
